          ...
          <div className="flex items-center justify-between h-16">
            ...
            <div className="flex items-center space-x-4">
              ...
              <motion.button
                ...
                whileTap={{ scale: 0.95 }}
                className="relative p-2 glass-effect border border-forensics-cyber-500/20 rounded-xl hover:border-forensics-cyber-400 transition-colors duration-300"
              >
                <Bell className="w-5 h-5 text-forensics-slate-300" />
